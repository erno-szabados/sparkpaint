package com.esgdev.sparkpaint.io;
        ...
        import com.esgdev.sparkpaint.engine.HistoryManager;
        ...
        public class FileManager {
             ...
             */
            public HistoryManager.LayerState loadFromFile(File file) throws IOException {
                ...
                currentFilePath = file.getAbsolutePath();
                return new HistoryManager.LayerState(layers, 0);
            }
