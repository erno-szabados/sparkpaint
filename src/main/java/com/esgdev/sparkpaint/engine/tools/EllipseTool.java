...
import com.esgdev.sparkpaint.engine.tools.renderers.EllipseToolRenderer;
...
public class EllipseTool implements DrawingTool {
    ...
    // Add EllipseToolRenderer field
    private final EllipseToolRenderer renderer;
    ...
    public void mouseDragged(MouseEvent e) {
        ...
        Rectangle bounds = renderer.calculateEllipseBounds(startPoint, point, isShiftDown, isCenterBased);

        // Draw the ellipse preview
        renderer.drawEllipse(tempCanvas, g2d, bounds,
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        // Calculate ellipse bounds - is shift down for perfect circle?
        boolean isShiftDown = (e.getModifiersEx() & MouseEvent.SHIFT_DOWN_MASK) != 0;
        Rectangle bounds = renderer.calculateEllipseBounds(drawContext.start, drawContext.end, isShiftDown, isCenterBased);

        // Draw the final ellipse
        renderer.drawEllipse(drawContext.targetImage, drawContext.g2d, bounds,
                canvas.getDrawingColor(), canvas.getFillColor(),
